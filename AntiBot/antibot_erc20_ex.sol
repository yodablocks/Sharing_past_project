...
contract ERC20 is IERC20, Ownable {
  ...
  constructor(
    ...
    // Initiate AntiBot instance from its address
    AntiBot = IPAntiBot(AntiBot_);
    // Register deployer as the owner of this token with AntiBot contract
    AntiBot.setTokenOwner(msg.sender);
    // Enable using AntiBot in this contract
    antiBotEnabled = true;
  }

  // When you done launching your tokens, simply set this to
  // false so your token does not use AntiBot anymore
  ...
  function _transfer(
    ...
    // disable AntiBot in your token instead of interacting with the
    // AntiBot contract
    if (antiBotEnabled) {
